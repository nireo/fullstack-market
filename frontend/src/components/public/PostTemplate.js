    ...
    <div className="col-md 4">
      <div className="card" style={{ marginTop: '1rem' }}>
        <div className="card-body">
          ...
          {user && <Link className="card-link" onClick={addToCart}></Link>}
          <Link to={`/community/post/${post._id}`} className="card-link">
            Read more
          </Link>
        </div>
      </div>
...
export default connect(mapStateToProps, { addItemToCart })(PostTemplate);
