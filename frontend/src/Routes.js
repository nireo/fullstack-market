        ...
        <Router>
            ...
            <Switch>
                ...
                <Route
                    ...
                    render={({ match }) =>
                        !props.posts ? (
                            ...
                            <SinglePost
                                post={findPostWithId(match.params.id)}
                            />
                        )
                    }
                />
                <Route
                    ...
                    path="/create"
                    render={() =>
                        !props.user ? <Redirect to="/" /> : <CreatePost />
                    }
                />
                <Route
                    exact
                ...
                <Route
                    ...
                    path="/official/:id"
                    render={({ match }) => (
                        <SingleMainPost id={match.params.id} />
                    )}
                />
                ...
                <Route
                    ...
                    path="/owned-items"
                    render={() =>
                        props.user ? <OwnedItems /> : <Redirect to="/" />
                    }
                />
                <Route
                    exact
                ...
                <Route
                    ...
                    path="/settings"
                    render={() =>
                        props.user ? <SettingsMain /> : <Redirect to="/" />
                    }
                />
                <Route
                    exact
